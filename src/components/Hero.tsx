...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      style={{ maskImage: 'radial-gradient(ellipse 80% 50% at 50% 50%, #000 10%, transparent 100%)' }} />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div ref={buttonsRef} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
          <button
        ...
        <div ref={socialLinksRef} className="flex items-center justify-center gap-4">
