...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.info(t.contact.sendMessage)
    ...
    <section id='contact' ref={sectionRef} className='py-32 px-6 bg-muted/30'>
      <div className='max-w-6xl mx-auto'>
        <div className='text-center mb-20'>
          <h2 className='text-5xl md:text-6xl mb-4'>{t.contact.title}</h2>
        ...
        <div className='grid md:grid-cols-2 gap-12'>
          ...
          <div className='space-y-6'>
            <p className='text-muted-foreground mb-8'>{t.contact.titleLeft}</p>
            ...
            {socialLinks.map(link => (
              <a
                ...
                className='contact-card group p-6 flex items-center justify-between border-border rounded-xl bg-background hover:bg-accent transition-all duration-300 hover:scale-105'
              >
            ...
            {/* Availability Badge */}
            <div className='contact-card group block p-6 border border-border rounded-xl bg-background'>
          ...
          <div className='contact-card'>
            ...
            >
              <h3 className='text-muted-foreground'>{t.contact.titleRight}</h3>
              <div>
