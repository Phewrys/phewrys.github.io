...
export const workExperience: WorkExperience[] = [
  {
    ...
    activities: {
      en: [
        'Responsible for the development and maintenance of web applications, applying good security, performance, accessibility and SEO practices.',
      ...
      pt: [
        'Responsável pelo desenvolvimento e manutenção de aplicações web, aplicando boas práticas de segurança, performance, acessibilidade e SEO.',
  ...
  },
  {
    ...
    activities: {
      en: [
        'Evolution and addition of features in projects, promoting continuous updating of solutions.',
      ...
      pt: [
        'Evolução e adição de funcionalidades nos projetos, promovendo a atualização contínua das soluções.',
  ...
  },
  {
    ...
    activities: {
      en: [
        'Landingpage development using React, Typescript and Styles Components.',
        'Investigation and resolution of incidents, ensuring system stability.',
        'CI/CD using Jenkins and UrbanCode.',
      ],
      pt: [
        'Desenvolvimento de Landingpage utilizando React, Typescript e Styles Components.',
  ...
  },
  {
    ...
    activities: {
      en: [
        'Development of an internal application using .NET Framework, ASP.NET MVC 5 and SQL Server.',
      ...
      pt: [
        'Desenvolvimento de uma aplicação interna utilizando .NET Framework, ASP.NET MVC 5 e SQL Server.',
...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description:
        'Crafting modern, engaging, and performant web experiences with cutting-edge technologies. Passionate about clean code, stunning interfaces, and seamless user experiences.',
      cta1: 'View Projects',
      cta2: 'Contact Me',
      cvText: 'Download Resume',
      cvTitle: 'Tiago_Farias_Frontend_Developer_Resume.pdf',
      cvHref: '/assets/Tiago_Farias_Frontend_Developer_Resume.pdf',
    },
    about: {
      title: 'About Me',
    ...
    contact: {
      ...
      sendMessage:
        'Service currently unavailable, try one of the contact methods on the side.',
    },
    footer: {
  ...
  pt: {
    ...
    hero: {
      ...
      description:
        'Criando experiências web modernas, envolventes e performáticas com tecnologias de ponta. Apaixonado por código limpo, interfaces impressionantes e experiências de usuário perfeitas.',
      cta1: 'Ver Projetos',
      cta2: 'Entre em Contato',
      cvText: 'Baixar Currículo',
      cvTitle: 'CV_Tiago_Farias_Desenvolvedor_Frontend.pdf',
      cvHref: '/assets/CV_Tiago_Farias_Desenvolvedor_Frontend.pdf',
    },
    about: {
      title: 'Sobre Mim',
    ...
    contact: {
      ...
      descriptionAvailabilityBadge:
        'Aberto a projetos freelance e oportunidades de tempo integral',
      form: {
        name: 'Nome',
        email: 'Email',
        message: 'Mensagem',
      ...
      sendMessage:
        'Serviço indisponível no momento, tente um dos métodos de contato ao lado.',
    },
    footer: {
